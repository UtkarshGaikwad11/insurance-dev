...
export default function CustomersPage() {
  // ✅ Fixed: use `items` instead of `list`
  const policies = useSelector((state: RootState) => state.policies.items || []);

  // ✅ Safe handling if no policies exist
      ...
      <Card className="shadow-lg">
        <CardHeader className="border-b">
          ...
          <p className="text-sm text-gray-500 mt-1">
            List of all customers and their policies
          </p>
        </CardHeader>
        ...
        <CardContent className="p-0">
          {customers.length > 0 ? (
                  ...
                  {customers.map((c) => (
                    ...
                    >
                      ...
                      <td className="p-4 text-sm font-semibold text-gray-900">
                        ₹{Number(c.premium || 0).toLocaleString()}
                      </td>
            ...
            <div className="p-6 text-center text-gray-500 text-sm">
              No customers found. Add a policy to see customer data.
            </div>
          )}
        </CardContent>
      </Card>
